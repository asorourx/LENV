# Pyenv to set python3 as default
...
# export PATH=$HOME/bin:/Volumes/H1/:$PATH

export PATH=$HOME:/opt/homebrew/bin:/opt/homebrew/sbin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/opt/homebrew/bin:/opt/homebrew/sbin:/opt/metasploit-framework/bin
...
export ZSH="/Volumes/H1/LENV/oh-my-zsh"
...
# Created by `pipx` on 2022-03-04 05:27:55
export PATH="$PATH:/Users/amrx/.local/bin"
